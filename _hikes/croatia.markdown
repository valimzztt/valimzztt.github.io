...
komoot_link: "https://www.alltrails.com/trail/canada/quebec/mont-ham--2"
gallery:
  ...
  <aside class="hike-sidebar">
    <div class="hike-card stats-card">
      ...
      <div class="stat-item">
        ...
        <span class="stat-value">Mont Ham, QC</span>
      </div>
      ...
      <div class="hike-actions">
        ...
        <a href="{{ page.komoot_link }}" target="_blank" class="hike-btn btn-primary">View on AllTrails</a>
      </div>
    </div>
  </aside>
